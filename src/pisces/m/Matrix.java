    ...
    implements Cloneable
{
    ...
    public final Matrix setScale(double scale)
    {
        ...
        this.m00 = Z1(tmp_rot[0] * scale);
        this.m01 = Z1(tmp_rot[1] * scale);
        this.m02 = Z1(tmp_rot[2] * scale);

        this.m10 = Z1(tmp_rot[3] * scale);
        this.m11 = Z1(tmp_rot[4] * scale);
        this.m12 = Z1(tmp_rot[5] * scale);

        this.m20 = Z1(tmp_rot[6] * scale);
        this.m21 = Z1(tmp_rot[7] * scale);
        this.m22 = Z1(tmp_rot[8] * scale);
        return this;
    }
    /**
    ...
    public final Matrix setElement(int row, int column, double value)
    {
        ...
        case 0:
            ...
            case 2:
                ...
                break;
            default:
                throw new ArrayIndexOutOfBoundsException(String.valueOf(row));
            }
            break;
    ...
    public final double getElement(int row, int column)
    {
        ...
        case 0:
            ...
            case 2:
                return this.m02;
            default:
                throw new ArrayIndexOutOfBoundsException(String.valueOf(column));
            }
    ...
    {
        this.m00 = Z1(1.0 - 2.0*q1.y*q1.y - 2.0*q1.z*q1.z);
        this.m10 = Z1(2.0*(q1.x*q1.y + q1.w*q1.z));
        this.m20 = Z1(2.0*(q1.x*q1.z - q1.w*q1.y));

        this.m01 = Z1(2.0*(q1.x*q1.y - q1.w*q1.z));
        this.m11 = Z1(1.0 - 2.0*q1.x*q1.x - 2.0*q1.z*q1.z);
        this.m21 = Z1(2.0*(q1.y*q1.z + q1.w*q1.x));

        this.m02 = Z1(2.0*(q1.x*q1.z + q1.w*q1.y));
        this.m12 = Z1(2.0*(q1.y*q1.z - q1.w*q1.x));
        this.m22 = Z1(1.0 - 2.0*q1.x*q1.x - 2.0*q1.y*q1.y);
    ...
    public final Matrix set(AxisAngle a1)
    {
        ...
        if ( 0.0 == Z(mag))
            ...
            this.m00 = Z1(t * ax * ax + cosTheta);
            this.m01 = Z1(t * xy - sinTheta * az);
            this.m02 = Z1(t * xz + sinTheta * ay);

            this.m10 = Z1(t * xy + sinTheta * az);
            this.m11 = Z1(t * ay * ay + cosTheta);
            this.m12 = Z1(t * yz - sinTheta * ax);

            this.m20 = Z1(t * xz - sinTheta * ay);
            this.m21 = Z1(t * yz + sinTheta * ax);
            this.m22 = Z1(t * az * az + cosTheta);
    ...
    {
        return  Z1(this.m00*(this.m11*this.m22 - this.m12*this.m21)
    ...
    {
        this.m00 = Z1(this.m00 * scalar);
        this.m01 = Z1(this.m01 * scalar);
        this.m02 = Z1(this.m02 * scalar);

        this.m10 = Z1(this.m10 * scalar);
        this.m11 = Z1(this.m11 * scalar);
        this.m12 = Z1(this.m12 * scalar);

        this.m20 = Z1(this.m20 * scalar);
        this.m21 = Z1(this.m21 * scalar);
        this.m22 = Z1(this.m22 * scalar);
    ...
    {
        this.m00 = Z1(scalar * m1.m00);
        this.m01 = Z1(scalar * m1.m01);
        this.m02 = Z1(scalar * m1.m02);

        this.m10 = Z1(scalar * m1.m10);
        this.m11 = Z1(scalar * m1.m11);
        this.m12 = Z1(scalar * m1.m12);

        this.m20 = Z1(scalar * m1.m20);
        this.m21 = Z1(scalar * m1.m21);
        this.m22 = Z1(scalar * m1.m22);
    ...
    public final Matrix mul(Matrix m1)
    {
        ...
        this.m00 = Z1(m00); this.m01 = Z1(m01); this.m02 = Z1(m02);
        this.m10 = Z1(m10); this.m11 = Z1(m11); this.m12 = Z1(m12);
        this.m20 = Z1(m20); this.m21 = Z1(m21); this.m22 = Z1(m22);
    ...
    {
        if (this != m1 && this != m2) {
            this.m00 = Z1(m1.m00*m2.m00 + m1.m01*m2.m10 + m1.m02*m2.m20);
            this.m01 = Z1(m1.m00*m2.m01 + m1.m01*m2.m11 + m1.m02*m2.m21);
            this.m02 = Z1(m1.m00*m2.m02 + m1.m01*m2.m12 + m1.m02*m2.m22);

            this.m10 = Z1(m1.m10*m2.m00 + m1.m11*m2.m10 + m1.m12*m2.m20);
            this.m11 = Z1(m1.m10*m2.m01 + m1.m11*m2.m11 + m1.m12*m2.m21);
            this.m12 = Z1(m1.m10*m2.m02 + m1.m11*m2.m12 + m1.m12*m2.m22);

            this.m20 = Z1(m1.m20*m2.m00 + m1.m21*m2.m10 + m1.m22*m2.m20);
            this.m21 = Z1(m1.m20*m2.m01 + m1.m21*m2.m11 + m1.m22*m2.m21);
            this.m22 = Z1(m1.m20*m2.m02 + m1.m21*m2.m12 + m1.m22*m2.m22);
        }
        else {
    ...
    public final Matrix mulNormalize(Matrix m1){
        ...
        this.m00 = Z1(tmp_rot[0]);
        this.m01 = Z1(tmp_rot[1]);
        this.m02 = Z1(tmp_rot[2]);

        this.m10 = Z1(tmp_rot[3]);
        this.m11 = Z1(tmp_rot[4]);
        this.m12 = Z1(tmp_rot[5]);

        this.m20 = Z1(tmp_rot[6]);
        this.m21 = Z1(tmp_rot[7]);
        this.m22 = Z1(tmp_rot[8]);
    ...
    {
        if (this != m1 && this != m2) {
            this.m00 = Z1(m1.m00*m2.m00 + m1.m10*m2.m01 + m1.m20*m2.m02);
            this.m01 = Z1(m1.m00*m2.m10 + m1.m10*m2.m11 + m1.m20*m2.m12);
            this.m02 = Z1(m1.m00*m2.m20 + m1.m10*m2.m21 + m1.m20*m2.m22);

            this.m10 = Z1(m1.m01*m2.m00 + m1.m11*m2.m01 + m1.m21*m2.m02);
            this.m11 = Z1(m1.m01*m2.m10 + m1.m11*m2.m11 + m1.m21*m2.m12);
            this.m12 = Z1(m1.m01*m2.m20 + m1.m11*m2.m21 + m1.m21*m2.m22);

            this.m20 = Z1(m1.m02*m2.m00 + m1.m12*m2.m01 + m1.m22*m2.m02);
            this.m21 = Z1(m1.m02*m2.m10 + m1.m12*m2.m11 + m1.m22*m2.m12);
            this.m22 = Z1(m1.m02*m2.m20 + m1.m12*m2.m21 + m1.m22*m2.m22);
        }
        else {
    ...
    {
        if (this != m1 && this != m2) {
            this.m00 = Z1(m1.m00*m2.m00 + m1.m01*m2.m01 + m1.m02*m2.m02);
            this.m01 = Z1(m1.m00*m2.m10 + m1.m01*m2.m11 + m1.m02*m2.m12);
            this.m02 = Z1(m1.m00*m2.m20 + m1.m01*m2.m21 + m1.m02*m2.m22);

            this.m10 = Z1(m1.m10*m2.m00 + m1.m11*m2.m01 + m1.m12*m2.m02);
            this.m11 = Z1(m1.m10*m2.m10 + m1.m11*m2.m11 + m1.m12*m2.m12);
            this.m12 = Z1(m1.m10*m2.m20 + m1.m11*m2.m21 + m1.m12*m2.m22);

            this.m20 = Z1(m1.m20*m2.m00 + m1.m21*m2.m01 + m1.m22*m2.m02);
            this.m21 = Z1(m1.m20*m2.m10 + m1.m21*m2.m11 + m1.m22*m2.m12);
            this.m22 = Z1(m1.m20*m2.m20 + m1.m21*m2.m21 + m1.m22*m2.m22);
        }
        else {
    ...
    public final Matrix mulTransposeLeft(Matrix m1, Matrix m2) {
        if (this != m1 && this != m2) {
            this.m00 = Z1(m1.m00*m2.m00 + m1.m10*m2.m10 + m1.m20*m2.m20);
            this.m01 = Z1(m1.m00*m2.m01 + m1.m10*m2.m11 + m1.m20*m2.m21);
            this.m02 = Z1(m1.m00*m2.m02 + m1.m10*m2.m12 + m1.m20*m2.m22);

            this.m10 = Z1(m1.m01*m2.m00 + m1.m11*m2.m10 + m1.m21*m2.m20);
            this.m11 = Z1(m1.m01*m2.m01 + m1.m11*m2.m11 + m1.m21*m2.m21);
            this.m12 = Z1(m1.m01*m2.m02 + m1.m11*m2.m12 + m1.m21*m2.m22);

            this.m20 = Z1(m1.m02*m2.m00 + m1.m12*m2.m10 + m1.m22*m2.m20);
            this.m21 = Z1(m1.m02*m2.m01 + m1.m12*m2.m11 + m1.m22*m2.m21);
            this.m22 = Z1(m1.m02*m2.m02 + m1.m12*m2.m12 + m1.m22*m2.m22);
        }
        else {
    ...
    public final Matrix normalizeCP()
    {
        ...
        this.m02 = Z1(m10*m21 - m11*m20);
        this.m12 = Z1(m01*m20 - m00*m21);
        this.m22 = Z1(m00*m11 - m01*m10);
    ...
    public final Matrix normalizeCP(Matrix m1)
    {
        ...
        this.m00 = Z1(m1.m00*mag);
        this.m10 = Z1(m1.m10*mag);
        this.m20 = Z1(m1.m20*mag);

        mag = 1.0/Math.sqrt(m1.m01*m1.m01 + m1.m11*m1.m11 + m1.m21*m1.m21);
        this.m01 = Z1(m1.m01*mag);
        this.m11 = Z1(m1.m11*mag);
        this.m21 = Z1(m1.m21*mag);
    ...
    public boolean equals(Matrix m1)
    {
        if (this == m1)
            ...
            return (EEQ(this.m00, m1.m00) && EEQ(this.m01, m1.m01) && EEQ(this.m02, m1.m02)
                    && EEQ(this.m10, m1.m10) && EEQ(this.m11, m1.m11) && EEQ(this.m12, m1.m12)
                    && EEQ(this.m20, m1.m20) && EEQ(this.m21, m1.m21) && EEQ(this.m22, m1.m22));
    }
    /**
...
//        }
     ...
     */
    private final void invertGeneral(Matrix  m1) {
        ...
        if (!luDecomposition(tmp, row_perm)) {
            ...
            throw new IllegalStateException("Matrix has no inverse");
        }
        else {
            /*
